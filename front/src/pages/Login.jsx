            ...
            <div style={styles.formWrapper}>
              ...
              <div style={styles.captchaRow}>
                <label style={styles.captchaLabel}>
                  ...
                  />
                  <span style={styles.captchaText}>I'm not a robot</span>
                </label>
              </div>
...
const styles = {
  ...
  card: {
    ...
    background: 'linear-gradient(180deg, #2d3a6a 0%, #34446a 100%)',
    position: 'relative',
    zIndex: 10,
  },
  leftPanel: {
  ...
  overlay: {
    ...
    width: '100%',
    height: '100%',
    background: 'linear-gradient(180deg, rgba(30, 43, 79, 0.4) 0%, rgba(42, 54, 88, 0.5) 100%)',
  },
  rightPanel: {
    flex: '1',
    background: 'linear-gradient(135deg, #1e2b4f 0%, #2a3658 100%)' ,
    padding: '40px',
    display: 'flex',
    alignItems: 'center',
  },
  ...
  button: {
    width: '100%',
    background: 'linear-gradient(135deg, #4a5a8e 0%, #5a6a9e 100%)',
    color: 'white',
    border: 'none',
    borderRadius: '10px',
    padding: '15px',
    ...
    transition: 'all 0.3s',
    marginTop: '12px',
    boxShadow: '0 4px 15px rgba(74, 90, 142, 0.3)',
  },
  error: {
